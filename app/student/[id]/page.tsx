                        ...
                        {matiereRes
                            ...
                            .map((mat) => (
                                <tr key={mat.r} className='text-xs font-semibold md:text-lg border-b-2'>                                
                                    ...
                                    <div className=' w-10 text-center md:w-20 h-10 md:h-15 py-2 '>{mat.nd}</div>
                                    <div className=' w-10 text-center md:w-20 h-10 md:h-15 py-2 '>{mat.ne}</div>
                                    <div className=' w-10 text-center md:w-20 h-10 md:h-15 py-2 '>{mat.nf}</div>
                                    <div className=' w-10 md:w-20 text-center md:w-15 h-10 md:h-15 py-2 '>{mat.d}</div>
                                    </td>
                                </tr>
                            ))}
                            </tbody>
